...
The "activitylabel" columns contains 6 types of activities, including:

WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING

The tidy data contains 68 columns, including 2 columns of "activitylabel" and "subject", and 66 specific data columns:
